...
export const CLAUDE_API = {
  ...
  MAX_TOKENS_PER_CHAPTER: 7000, // Limit per chapter in chunked generation (reduced for smaller chunks)
  MAX_TOKENS_SINGLE_GENERATION: 7000, // Limit for single-call generation
